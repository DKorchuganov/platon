...
This folder explains the project step by step.

The text is simple on purpose. It is for a Kotlin developer who is new to web frontend work.

Read the files in this order:

1. [00-start-here.md](00-start-here.md)
2. [01-project-structure.md](01-project-structure.md)
3. [02-web-basics-without-fear.md](02-web-basics-without-fear.md)
4. [03-compose-basics.md](03-compose-basics.md)
5. [04-data-model.md](04-data-model.md)
6. [05-layout-and-state.md](05-layout-and-state.md)
7. [06-canvas-grid-and-clicks.md](06-canvas-grid-and-clicks.md)
8. [07-build-and-run.md](07-build-and-run.md)
9. [08-small-exercises.md](08-small-exercises.md)
